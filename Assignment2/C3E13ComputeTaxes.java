...
public class C3E13ComputeTaxes {

	public static void main(String[] args) {
		System.out.println("This program will calculate taxes for a user based off of filing status and income.\n");
	    ...
	    if (status == 0) { // Compute tax for single filers
	      if (income <= 8350) {
	    	...
	    	if(income <= 16700) {
		        ...
		        tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (208850 - 137050) * 0.28 + (income - 208850) * 0.35;
	    	}else {
	    	...
	    	if(income <= 8350) {
		        ...
		        tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (104425 - 68525) * 0.28 + (income - 104425) * 0.35;
	    	}else {
	    	...
	    	if(income <= 11950) {
	            ...
	            tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (117450 - 45500) * 0.25 + (190200 - 117450) * 0.28 + (income - 190200) * 0.35;
	    	}else {
